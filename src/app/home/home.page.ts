...
import { SimpleAltertService } from "../services/simple-altert.service"; 
...
export class HomePage implements OnInit {
  ...
  constructor(
    ...
    private simpleAlert: SimpleAltertService,    
  ...
  playSlideshow(): void {
    ...
    if (this.photoService.photos.length > 1) {      
      ...
      .then(modal => {          
        ...
        this.simpleAlert.createAlert("Oops!", "You need at least two photos before you can play a slideshow.")        
        .then(alert => {          
          alert.present();        
        });    
      }
